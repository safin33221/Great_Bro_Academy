      ...
      <div className=" py-12 px-4 md:px-8 lg:px-16   mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div
            ...
            className="bg-card   rounded-t-xl border-b-4 border-b-orange-400 p-6 shadow-md hover:shadow-lg transition">
          ...
          <div
            ...
            className="bg-card  shadow-t-xl border-b-4 border-b-orange-400 rounded-t-xl p-6  hover:shadow-lg transition">
